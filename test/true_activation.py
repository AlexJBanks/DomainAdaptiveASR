...
from util import save_dat, gen_naive_transcript, remove_non_speech
from asr import LanguageModel, _activation_functions

buckets = 20

file_name = 'true_activation'
...
def test(model):
    ...
    with open('../data/TED/ted_talks_en.csv', newline='', encoding='utf-8-sig') as csvfile:
        ...
        for i, row in enumerate(reader):
            ...
            domains = model.extract_domain(gen_naive_transcript(model, fake_audio, preprocessed=True, verbose=False),
